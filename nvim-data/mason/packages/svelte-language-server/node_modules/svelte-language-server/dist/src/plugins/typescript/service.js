...
async function createLanguageService(tsconfigPath, workspacePath, docContext) {
    ...
    const VERSION = (0, importPackage_1.importSvelte)(tsconfigPath || workspacePath).VERSION;
    const svelteTsxFiles = (VERSION.split('.')[0] === '3'
        ? ['./svelte-shims.d.ts', './svelte-jsx.d.ts', './svelte-native-jsx.d.ts']
        : ['./svelte-shims-v4.d.ts', './svelte-jsx-v4.d.ts', './svelte-native-jsx.d.ts']).map((f) => tsSystem.resolvePath((0, path_1.resolve)(svelteTsPath, f)));
